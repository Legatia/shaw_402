 ...
 */
export function verifyPaymentRoute(context) {
    return async (req, res) => {
        ...
        try {
            ...
            const isValidSignature = context.solanaUtils.verifyStructuredDataSignature(structuredData, signature, clientPublicKey);
