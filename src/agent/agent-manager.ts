...
import { PaymentProcessorAgent, PaymentProcessorConfig } from './payment-processor.js';
...
export class AgentManager {
  ...
  private agents: Map<string, PaymentProcessorAgent> = new Map();
  private platformUSDCAccount: string | null = null;
   ...
   */
  private async startAgentForMerchant(merchantData: any): Promise<void> {
    ...
    // Create agent config
    const agentConfig: PaymentProcessorConfig = {
      merchantData,
   ...
   */
  private async loadActiveMerchants(): Promise<any[]> {
    ...
    return new Promise((resolve, reject) => {
      const db = (this.config.affiliateDb as any).db;
   ...
   */
  async addMerchant(merchantIdParam: string): Promise<void> {
   ...
   */
  async removeMerchant(merchantIdParam: string): Promise<void> {
